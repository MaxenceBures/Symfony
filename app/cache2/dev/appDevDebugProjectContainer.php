...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/Applications/MAMP/htdocs/symfony/src/webStudent/EtudiantBundle/Resources/config/doctrine' => 'webStudent\\EtudiantBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'webStudent\\EtudiantBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('webStudentEtudiantBundle' => 'webStudent\\EtudiantBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/symfony/src/webStudent/StageBundle/Resources/views', 'webStudentEtudiant');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'webStudentEtudiantBundle' => 'webStudent\\StageBundle\\webStudentEtudiantBundle',
