...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setNamespace('sf2orm_default_74e177d276eb44fe5320b4545828e4d7');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Applications/MAMP/htdocs/symfony/src/webStudent/EtudiantBundle/Entity', 1 => '/Applications/MAMP/htdocs/symfony/src/webStudent/UserBundle/Entity', 2 => '/Applications/MAMP/htdocs/symfony/src/webStudent/EntrepriseBundle/Entity', 3 => '/Applications/MAMP/htdocs/symfony/src/webStudent/StageBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'webStudent\\EtudiantBundle\\Entity');
        $f->addDriver($e, 'webStudent\\UserBundle\\Entity');
        $f->addDriver($e, 'webStudent\\EntrepriseBundle\\Entity');
        $f->addDriver($e, 'webStudent\\StageBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('webStudentEtudiantBundle' => 'webStudent\\EtudiantBundle\\Entity', 'webStudentUserBundle' => 'webStudent\\UserBundle\\Entity', 'webStudentEntrepriseBundle' => 'webStudent\\EntrepriseBundle\\Entity', 'webStudentStageBundle' => 'webStudent\\StageBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/Applications/MAMP/htdocs/symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('webStudent\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i->createUser(new \Symfony\Component\Security\Core\User\User('user', 'userpass', array(0 => 'ROLE_ADMIN')));

        $j = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $k->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('always_use_default_target_path' => true, 'default_target_path' => '/Accueil', 'login_path' => 'login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $l->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $i, 1 => $this->get('security.user.provider.concrete.main')), 'main', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'main', $l, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '539b66a052528', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('cache' => false, 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/symfony/src/webStudent/UserBundle/Resources/views', 'webStudentUser');
        $instance->addPath('/Applications/MAMP/htdocs/symfony/src/webStudent/EntrepriseBundle/Resources/views', 'webStudentEntreprise');
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'webStudent\\UserBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'webStudentUserBundle' => 'webStudent\\UserBundle\\webStudentUserBundle',
                'webStudentEntrepriseBundle' => 'webStudent\\EntrepriseBundle\\webStudentEntrepriseBundle',
